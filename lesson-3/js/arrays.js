...
output.textContent = stringArray[0];
// Output the last element of the array
console.log(`last array element is ${stringArray[stringArray.length - 1]}`);
...
Use join() and toString() - note that join() allows you to choose and insert a delimiter, while toString() does not */
    //let stringArrayString = stringArray.toString();
let stringArrayString = stringArray.join(" | ");
console.log(stringArrayString);
